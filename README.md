...
Link to main YAML installation file: [Full VN ELK Setup](https://github.com/BrettB76/Brett_Benson_Cyber_knowledge/blob/main/Ansible/Full_VN_ELK_setup_yml.txt)
